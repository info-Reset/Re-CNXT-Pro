...
const ClientDetailView: React.FC<ClientDetailViewProps> = ({ client, onBack, onUpdate, onDelete }) => {
  ...
  const handleDraftEmail = async (context: string) => {
    setIsDrafting(true);
    // Provide richer context for the AI draft
  ...
  return (
    <div className="max-w-6xl mx-auto space-y-6 pb-20">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        {/* Right Column: Projects, Notes & AI Results */}
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="bg-white rounded-[2rem] shadow-sm border border-slate-200 p-8">
            ...
            <div className="flex gap-4 mb-8">
              <input 
                type="text" 
                placeholder="Describe a website mockup (e.g. 'Sleek luxury real estate landing page in gold and black')"
                className="flex-1 bg-slate-50 border border-slate-200 rounded-2xl px-4 py-3 text-sm font-medium focus:ring-4 focus:ring-indigo-500/10 outline-none"
                value={mockupPrompt}
